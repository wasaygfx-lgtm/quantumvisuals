        ...
        <main className="relative z-10 py-20 sm:py-32 flex-grow">
          <section className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-4xl mx-auto bg-black/30 backdrop-blur-sm border border-primary/30 rounded-2xl p-8 space-y-8 text-left">
                <div>
                    <h2 className="text-2xl font-bold text-primary mb-4">Our Graphic Design Expertise</h2>
                    <p className="text-muted-foreground leading-relaxed">
                        At Quantum Visuals, we believe that great design is at the heart of every successful brand. Our graphic design services are tailored to help your business stand out with visually compelling and memorable assets. We combine creativity with strategy to deliver designs that not only look good but also achieve your business goals.
                    </p>
                </div>
                <div>
                    <h3 className="text-xl font-semibold text-foreground mb-2">Logo Design & Branding</h3>
                    <p className="text-muted-foreground leading-relaxed">
                        Your logo is the face of your brand. We create unique and timeless logos that capture the essence of your business. Our branding packages include style guides, color palettes, and typography to ensure consistency across all your marketing materials.
                    </p>
                </div>
                <div>
                    <h3 className="text-xl font-semibold text-foreground mb-2">Marketing & Advertising Materials</h3>
                    <p className="text-muted-foreground leading-relaxed">
                        From brochures and flyers to social media graphics and web banners, we design a wide range of marketing materials that grab attention and drive engagement. We ensure that every piece is aligned with your brand identity and marketing objectives.
                    </p>
                </div>
                 <div>
                    <h3 className="text-xl font-semibold text-foreground mb-2">Custom Illustrations</h3>
                    <p className="text-muted-foreground leading-relaxed">
                        Add a unique touch to your brand with custom illustrations. Our talented illustrators can create everything from simple icons to complex scenes that tell your brand's story in a visually engaging way.
                    </p>
                </div>
