          ...
          <section className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Helping you reach your target audience and grow your business with our expertise in the digital landscape.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto bg-black/30 backdrop-blur-sm border border-primary/30 rounded-2xl p-8 space-y-8 text-left">
                <div>
                    <h2 className="text-2xl font-bold text-primary mb-4">Our Digital Marketing Services</h2>
                ...
                <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        We improve your website's visibility on search engines like Google to attract organic traffic. Our SEO strategies include keyword research, on-page optimization, link building, and technical SEO to ensure you rank higher than your competitors.
                    </p>
                </div>
                <div>
                    <h3 className="text-xl font-semibold text-foreground mb-2">Social Media Marketing</h3>
                    <p className="text-muted-foreground leading-relaxed">
                        Engage with your audience on platforms like Instagram, Facebook, LinkedIn, and X. We create compelling content, manage your social media accounts, and run targeted ad campaigns to grow your following and drive engagement.
                    </p>
                </div>
                 <div>
                    <h3 className="text-xl font-semibold text-foreground mb-2">Content Marketing</h3>
                    <p className="text-muted-foreground leading-relaxed">
                        Content is king, and we help you create valuable and relevant content that attracts and retains a clearly defined audience. From blog posts and articles to videos and infographics, we produce content that drives profitable customer action.
                    </p>
                </div>
